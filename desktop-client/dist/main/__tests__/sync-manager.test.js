...
describe('SyncManager', () => {
    ...
    let mockOfflineCache;
    let mockAxiosInstance;
    beforeEach(() => {
        // Create mock instances
        mockServerConnection = new server_connection_1.ServerConnectionManager();
        mockOfflineCache = new offline_cache_1.OfflineCache();
        // Mock axios instance
        mockAxiosInstance = {
            get: jest.fn(),
            post: jest.fn(),
        ...
        syncManager = new sync_manager_1.SyncManager(mockServerConnection, mockOfflineCache);
    });
    afterEach(async () => {
    ...
    describe('syncNotes', () => {
        it('should sync notes from server', async () => {
            ...
            expect(mockOfflineCache.saveNote).toHaveBeenCalledWith(expect.objectContaining({
                ...remoteNotes[0],
                server_id: 'note-1',
                sync_status: 'synced',
            }));
    ...
    describe('conflict resolution', () => {
        beforeEach(() => {
            ...
            syncManager.syncStatus.conflicts = [conflict];
        });
